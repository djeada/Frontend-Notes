...
Open [`index.html`](index.html) in a modern browser. This dependency-free project uses local HTML, CSS and a small JavaScript form handler. Try the example pairs, narrow the viewport, move through the page with Tab, and submit an invalid email. The eight SVG illustrations are in [`assets/visual-examples`](../../assets/visual-examples) and embedded alongside the explanations in the original [HTML](../../notes/01_html.md), [CSS](../../notes/02_css.md), [CSS frameworks](../../notes/03_css_frameworks.md), [JavaScript](../../notes/04_javascript.md), [UX](../../notes/06_ux.md), [UI](../../notes/07_ui.md), and [quizzes](../../notes/12_quizes.md) chapters.
